...
class fToolsPlugin:
	...
	def initGui( self ):
		if int( self.QgisVersion ) < 1:
			QMessageBox.warning( self.iface.getMainWindow(), "fTools", QCoreApplication.translate( "fTools", "Quantum GIS version detected: " ) +unicode( self.QgisVersion )+".xx\n"
		...
		self.about = QAction( QIcon( ":/icons/help.png" ), QCoreApplication.translate( "fTools", "About fTools" ), self.iface.mainWindow() )
