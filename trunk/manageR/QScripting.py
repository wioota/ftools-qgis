...
class QScripting( QWidget ):
  ...
  def __init__( self, parent ):
    ...
    self.btn_parse.setIcon( QIcon( ":mActionConsole.png" ) )
    self.btn_parse.setAutoRaise( True )
    ...
    self.save_file_as.setAutoRaise( True )
    ...
    self.save_file.setAutoRaise( True )
    ...
    self.open_file.setAutoRaise( True )
    ...
    self.new_file.setAutoRaise( True )
